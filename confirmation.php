<?php include('inc/header.php') ?>
    ...
    <div class="row">
      ...
      <div id="wizard-container" class="col-md-8" style="display: none";">
      ...
      <div id="form-container" class="col-md-8" style="display: block;">
          ...
          <form id="form" action="<?= $_SERVER["PHP_SELF"] ?>" method="POST">
            ...
            <fieldset class="form-group">
              ...
              <?php
                foreach ($maritalStatuses as $maritalStatus) {
                  ...
                  if ($user->maritalStatus === $maritalStatus["value"]) {
                    echo 'checked="true" ';
                  }
                  echo "/> ";
            ...
            <div class="row" style="margin-top: 20px">
              <div class="col-xs-12 col-md-6">
                <button type="submit" disabled="true" class="btn btn-primary">Submit</button>
              </div>
              <div class="col-xs-12 col-md-6">
                <button type="reset" disabled="true" class="btn btn-secondary">Reset</button>
              </div>
            </div>
          </form>
        </main>
